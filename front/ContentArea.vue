...
<template>
  <div>
    ...
    <div class="container">
      ...
      <Applications v-if="view==='applications'" v-bind:applications="state.applications" v-bind:images="state.images" v-bind:remotes="state.remotes" v-bind:containers="state.containers" />
